...
function import_data(){
   ...
   $.ajax({
      url: 'modul/mod_operator/upload.php',
      data: formdata,
      processData: false,
      contentType: false,
      type: 'POST',
      success: function(data) {
         if(data=="ok"){
           ...
           document.location = "media.php?module=ujianop";
         }else{
            alert(data);
         }
      },
...
Data Bank Soal           </h1>
        ...
        <div class='col-xs-12'><!-- /.box -->
          ...
          <div class='box'>
            <div class='box-header'>
              <h3 class='box-title'><a href='?module=soalop&act=tambahsoal&id=$_GET[id]'><button type='button' class='btn btn-block btn-primary'><i class='glyphicon glyphicon-pencil'></i>  Tambah Soal</button></a></h3>
  ...
  ";		
	  ...
	  echo"</ol></td>
                <td width='80'> <a href=?module=soalop&act=editsoal&id=$r[id_soal] class='btn btn-info'><i class='fa fa-pencil'></i></a>   
   <a href=javascript:confirmdelete('$aksi?module=soalop&act=hapus&ujian=$_GET[id]&id=$r[id_soal]') 
  ...
  <div class='content-wrapper'>
    ...
    <section class='content-header'>
      ...
      <ol class='breadcrumb'>
        ...
        <li><a href='?module=soalop'>soal</a></li>
    ...
    <section class='content'>
      <div class='row'>
        <div class='col-xs-12'><!-- /.box -->
          ...
          <!-- Input addon -->
		  <form class='stdform stdform2' method=POST action='$aksi?module=soalop&act=input' enctype='multipart/form-data'>
    ...
    <section class='content'>
      <div class='row'>
        <div class='col-xs-12'><!-- /.box -->
          ...
          <!-- Input addon -->
		      <form class='stdform stdform2' method=POST enctype='multipart/form-data' action=$aksi?module=soalop&act=update>
